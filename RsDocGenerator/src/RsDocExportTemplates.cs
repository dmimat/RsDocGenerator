...
namespace RsDocGenerator
{
    ...
    internal class RsDocExportTemplates : RsDocExportBase
    {
        ...
        {
            string type;
            var scopeFilter = ScopeFilter.Language;
        ...
        {
            return string.Format("Reference__Templates_Explorer__{0}_Templates_{1}", type,
                lang.NormalizeStringForAttribute());
        }
