...
namespace RsDocGenerator
{
  [Action("RsDocExportMacros",  "Export Template Macros", Id = 7969)]
    internal class RsDocExportMacros : IExecutableAction
  {
    ...
    public void Execute(IDataContext context, DelegateExecute nextExecute)
    {
      using (var brwsr = new FolderBrowserDialog() {Description = "Choose where to save XML topics."})
      {
        ...
        string fileName = Path.Combine(saveDirectoryPath, macroTopicId + ".xml");
          ...
          macroRow.Add(expressionCell,
            ...
            new XElement("td", 
              ...
              new XElement("include",
                new XAttribute("src", "TR"),
                new XAttribute("include-id", "macros_" + macroId))));
        ...
        macroLibrary.Save(fileName);
        MessageBox.ShowInfo("macros saved successfully");
      }
    }
